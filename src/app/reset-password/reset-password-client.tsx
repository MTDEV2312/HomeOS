      ...
      <main className="bg-surface-dim h-screen overflow-y-auto text-on-surface font-body-md">
        <div className="min-h-full w-full flex items-center justify-center p-md">
          ...
          <div className="text-center flex flex-col items-center gap-sm">
            ...
            <h2 className="text-body-md text-on-surface-variant font-medium">Contraseña actualizada con éxito</h2>
      ...
      <main className="bg-surface-dim h-screen overflow-y-auto text-on-surface font-body-md">
        <div className="min-h-full w-full flex items-center justify-center p-md">
          ...
          <div className="text-center flex flex-col items-center gap-sm">
            ...
            <h2 className="text-body-md text-on-surface-variant font-medium">Configura tu nueva contraseña</h2>
            <p className="font-body-md text-body-md text-on-surface-variant">
    ...
    <main className="bg-surface-dim h-screen overflow-y-auto text-on-surface font-body-md">
      <div className="min-h-full w-full flex items-center justify-center p-md">
        ...
        <div className="text-center flex flex-col items-center gap-sm">
          ...
          <h2 className="text-body-md text-on-surface-variant font-medium">Ingresa tu código OTP</h2>
          <p className="font-body-md text-body-md text-on-surface-variant">
